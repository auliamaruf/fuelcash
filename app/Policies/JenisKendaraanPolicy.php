...
class JenisKendaraanPolicy
{
     ...
     */
    public function view(User $user, JenisKendaraan $jenisKendaraan): bool
    {
     ...
     */
    public function update(User $user, JenisKendaraan $jenisKendaraan): bool
    {
     ...
     */
    public function delete(User $user, JenisKendaraan $jenisKendaraan): bool
    {
     ...
     */
    public function forceDelete(User $user, JenisKendaraan $jenisKendaraan): bool
    {
     ...
     */
    public function restore(User $user, JenisKendaraan $jenisKendaraan): bool
    {
     ...
     */
    public function replicate(User $user, JenisKendaraan $jenisKendaraan): bool
    {
