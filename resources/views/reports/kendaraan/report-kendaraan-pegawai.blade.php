...
<head>
    <meta charset="utf-8">
    <title>Laporan Kendaraan Pegawai</title>
    <style>
        body {
...
<body>
    ...
    <h3 style="text-align: center;">DAFTAR KENDARAAN PEGAWAI</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $index + 1 }}</td>
                <td>{{ $record->jenisKendaraan->name }}</td>
                <td>{{ $record->nama_pemilik }}</td>
                <td>{{ $record->plat_nomor }}</td>
